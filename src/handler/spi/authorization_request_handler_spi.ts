...
import { Property } from 'https://deno.land/x/authlete_deno@v1.2.10/mod.ts';
...
export interface AuthorizationRequestHandlerSpi extends UserClaimProvider
{
     ...
     * current implementation of Authlete /auth/authorization
     ...
     * the implementation of Authlete `/auth/authorization/issue`
